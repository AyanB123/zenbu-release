...
export function PlanToolAdvice(
  ...
  console.log("[plan-advice] PlanToolAdvice called", {
    toolName: props.toolName,
    status: props.status,
    hasRawOutput: props.rawOutput != null,
  ...
  if (!plan) {
    console.log(
      "[plan-advice] plan tool call but no completed details yet; falling back to Original",
      { status: props.status, rawOutput: props.rawOutput },
    );
    return <Original {...props} />;
  }
